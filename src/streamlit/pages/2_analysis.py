...
def main():
    ...
    ticker_limit = total_tickers * 0.75 # At least 75 % of the tickers must be represented in the metric before it is shown.
...
def blocker():
    st.write("You have to select a stock of interest and one or multiple peers to use this page.")
